...
create index if not exists project_folders_parent_idx on project_folders(parent_folder_id, sort_order);
create index if not exists workflow_statuses_entity_idx on workflow_statuses(entity_type, sort_order);
